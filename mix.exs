defmodule Captcha.Mixfile do
  ...
  defp package do
    [
      name: :captcha,
      files: ["lib", "priv", "mix.exs", "README*", "LICENSE*", "src/*.[ch]", "test", "config", "Makefile"],
      maintainers: ["davidqhr"],
      licenses: ["MIT"],
      links: %{"GitHub" => "https://github.com/oddminng/elixir-captcha",
        "Docs" => "https://github.com/oddminng/elixir-captcha"}]
  end
end
